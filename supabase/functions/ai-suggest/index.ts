...
const NEW_PROMPTS: Record<string, string> = {
  ...
  prompt: "Generate a fresh, Suno/Udio-grade music generation prompt. No upper word limit — minimum 10 sentences. Different genre family from prior ideas. Include ALL of: (1) precise genre + subgenre, (2) BPM + key + scale/mode, (3) time signature + groove feel, (4) chord progression in roman numerals, (5) 5-8 named instruments with stereo position and frequency role, (6) rhythmic pattern (kick/snare/hat placement, swing), (7) full vocal description with processing chain (compression, reverb type/decay, delay timing, EQ) OR explicit instrumental note, (8) production palette with measurable values (stereo width %, reverb decay seconds, saturation character), (9) 2-3 reference artists with WHAT SPECIFICALLY to take from each, (10) vivid 2-sentence scene with sensory detail, (11) section-by-section dynamic arc with energy percentages, (12) mix targets (LUFS, true peak, mono bass cutoff). Every adjective paired with a specific instrument, technique, or measurable value.",
