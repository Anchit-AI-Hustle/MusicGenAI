...
Durations MUST sum to exactly ${durationSec}.`,
    ...
    // ================================================================
    await updateProgress(supabase, trackId, creationId, "Downloading generated audio", 0.75, 15);
    ...
    // ================================================================
    await updateProgress(supabase, trackId, creationId, "Finalizing track", 0.92, 5);
