...
serve(async (req) => {
  ...
  try {
    ...
    // ================================================================
    await updateProgress(supabase, trackId, creationId, "Analyzing user inputs and prompt", 0.02, etaRemaining, jobId, 1);
...
Generate a production brief with: genre, subgenre, tempo description, mood, atmosphere, environment, instrumentation (specific instruments/synths), energy curve, rhythmic style, and 5-8 texture keywords for variation.`,
    ...
    // ================================================================
    await updateProgress(supabase, trackId, creationId, "Planning song structure and segments", 0.07, etaRemaining, jobId, 3);
...
Durations MUST sum to exactly ${durationSec}.`,
    ...
    // ================================================================
    await updateProgress(supabase, trackId, creationId, "Stitching segments into final track", 0.82, 10, jobId, 6, totalSegments, totalSegments);
    ...
    // ================================================================
    await updateProgress(supabase, trackId, creationId, "Finalizing and saving audio output", 0.92, 5);
