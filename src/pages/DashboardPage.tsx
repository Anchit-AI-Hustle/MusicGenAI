...
export const DashboardPage: React.FC<DashboardPageProps> = ({ onAuthClick, onNavigate }) => {
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen flex items-center justify-center p-4 sm:p-8 relative overflow-hidden">
        ...
        <div className="absolute inset-0" style={{ backgroundImage: 'radial-gradient(circle at 20% 80%, rgba(34, 211, 238, 0.1) 0%, transparent 50%), radial-gradient(circle at 80% 20%, rgba(168, 85, 247, 0.1) 0%, transparent 50%)' }} />
        <motion.div 
        ...
        >
          <div className="relative mb-8">
            <div className="absolute inset-0 bg-gradient-to-r from-primary to-accent blur-3xl opacity-20 animate-pulse" />
            <div className="relative w-28 h-28 rounded-3xl bg-gradient-to-br from-primary/20 to-accent/20 flex items-center justify-center mx-auto border border-white/10 backdrop-blur-xl">
          ...
          <h2 className="font-display text-4xl font-bold bg-gradient-to-r from-white via-primary to-accent bg-clip-text text-transparent mb-4">Your Music Awaits</h2>
          ...
          <Button onClick={onAuthClick} variant="glow" size="lg" className="text-lg px-10 py-6">
            <Sparkles className="w-5 h-5 mr-2" /> Sign In to Continue
          </Button>
        </motion.div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen p-4 sm:p-6 lg:p-8 overflow-y-auto relative">
      ...
      <div className="absolute inset-0" style={{ backgroundImage: 'radial-gradient(circle at 30% 20%, rgba(34, 211, 238, 0.08) 0%, transparent 40%), radial-gradient(circle at 70% 80%, rgba(168, 85, 247, 0.08) 0%, transparent 40%)' }} />
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        >
          <div>
            <h1 className="font-display text-3xl sm:text-4xl font-bold text-white mb-1">
              <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Studio</span> Dashboard
            </h1>
        ...
        >
          <div className="glass-card rounded-2xl p-5 relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-primary/20 to-transparent rounded-full blur-2xl group-hover:from-primary/30 transition-all" />
          ...
          <div className="glass-card rounded-2xl p-5 relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-accent/20 to-transparent rounded-full blur-2xl group-hover:from-accent/30 transition-all" />
            <div className="relative flex items-center gap-4">
          ...
          <div className="glass-card rounded-2xl p-5 relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-green-500/20 to-transparent rounded-full blur-2xl group-hover:from-green-500/30 transition-all" />
            <div className="relative flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-green-500 to-green-500/60 flex items-center justify-center shadow-lg shadow-green-500/20">
          ...
          <div className="glass-card rounded-2xl p-5 relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-amber-500/20 to-transparent rounded-full blur-2xl group-hover:from-amber-500/30 transition-all" />
            <div className="relative flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-amber-500 to-amber-500/60 flex items-center justify-center shadow-lg shadow-amber-500/20">
        ...
        {/* Filter tabs styled as pill badges */}
        <motion.div 
          initial={{ opacity: 0, y: 20 }} 
          animate={{ opacity: 1, y: 0 }} 
